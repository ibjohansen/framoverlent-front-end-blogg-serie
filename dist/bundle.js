...
/***/ function(module, exports, __webpack_require__) {
	...
	var ReactFireMixin = __webpack_require__(162);
	        ...
	        return (
	            React.createElement("div", {className: "row"}, 
	                ...
	                React.createElement("div", {className: "col-6"}, 
	                    React.createElement("div", null, React.createElement("br", null), React.createElement("br", null), React.createElement("br", null)), 
	                    React.createElement("div", null, 
	                        React.createElement("p", null, React.createElement("h4", null, "Legg til tekst i feltet nedenfor, klikk på «legg til»" + " " +
	                            "og se at databasen blir populert umiddelbart" + " " +
	                            "Databasen resettes daglig, men du kan bruke nullstill-linken nedenfor" + " " +
	                            "om det står noe upassene der fra før..."))
	                    ), 
	                    React.createElement("div", null, 
	                        React.createElement("input", {ref: "theInput", type: "text"}), 
	                        React.createElement("span", null, " "), 
	                        React.createElement("button", {type: "button", name: "add", onClick: this.addInputString}, 
	                            "legg til"
	                        ), 
	                        " ", 
	                        React.createElement("button", {type: "button", name: "reset", onClick: this.resetFirebase}, 
	                            "nullstill database"
	                        )
	                    ), 
	                    React.createElement("div", null, 
	                        React.createElement("ul", null, 
	                            this.state.strings.map(function (string, key) {
	                                return (
	                                    React.createElement("li", {key: key}, string.text)
	                                );
	                            })
	                        )
	                    )
